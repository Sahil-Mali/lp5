...
int main() {
    ...
    printArray(temp, "Sequential Bubble Sorted Array");
    ...
    printArray(temp, "Parallel Bubble Sorted Array");
    cout << "Time: " << (end - start) << " sec\n";
    ...
    printArray(temp, "Sequential Merge Sorted Array");
    cout << "Time: " << (end - start) << " sec\n";
    ...
    printArray(temp, "Parallel Merge Sorted Array");
    cout << "Time: " << (end - start) << " sec\n";
